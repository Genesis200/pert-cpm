...
class Activity:
    """estructura básica de una actividad que contiene un id, predecesor, duración y recursos"""
...
class CriticalPath(QtGui.QMainWindow):
    """
    Obtiene la ruta crítica y la duración total para un conjunto de actividades en un proyecto,  
    esta clase también obtiene todas las rutas posibles en el proyecto
    ...
    def about(self):
        ...
        :return: None
        """
        QtGui.QMessageBox.about(self, "About PERT-CPM", "PERT-CPM Version 1.0\nAuthor: Eusebio Génesis")
